...
| `README.md` | GitHub 首頁、功能與安裝說明 | 功能或操作方式變更時 |
| `RELEASE-ARCHITECTURE.md` | 發布結構與流程規範 | 架構、檔案範圍或流程變更時 |
| `RELEASE-NOTES-vX.Y.Z.md` | 單一版本功能與驗證說明 | 每次發布 |
